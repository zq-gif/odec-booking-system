            ...
            <div className="py-8">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        <h2 className="text-lg font-semibold text-gray-900 mb-6">Past Bookings</h2>
                    ...
                    <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-6">
                            ...
                            <div className="border-t border-gray-200 pt-6">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <p className="text-xl font-bold text-gray-900">${selectedBooking.totalAmount}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 flex justify-end gap-3">
                            ...
                            {selectedBooking.status === 'confirmed' && (
                                <>
                                    <button className="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 font-medium">
                                        Modify Booking
                                    </button>
