...
export default function GuestLayout({ children }) {
    return (
        <div className="flex min-h-screen flex-col items-center bg-gradient-to-b from-orange-50 via-amber-50 to-yellow-50 pt-6 sm:justify-center sm:pt-0 relative overflow-hidden">
            {/* Decorative Elements */}
